...
#-------------------------------------------------------------------------------------------------
# Import data
heatmap.dataset2 = read.csv("Colombia_RF_Mid_point.csv")
...
Plot2
ggsave("Fig3d_ii.pdf", height=1.8, width=4.2, units='in', plot = Plot2)
...
ggsave("Fig3d_ii_legend.pdf", height=4, width=8, units='in', plot = legend)

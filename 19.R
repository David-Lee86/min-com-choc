...
#-------------------------------------------------------------------------------------------------
# Import data
heatmap.dataset2 = read.csv("Colombia_RF_Area_under_curve.csv")
...
Plot2
ggsave("Fig3d_iii.pdf", height=1.8, width=4.2, units='in', plot = Plot2)
...
ggsave("Fig3d_iii_legend.pdf", height=4, width=8, units='in', plot = legend)

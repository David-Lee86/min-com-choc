...
ps1_fam <- microbiome::aggregate_rare(ps1, "Family", detection = 1/100, prevalence = 3/100)
ps1_fam
...
F1a
ggsave("Fig2f.pdf", height=1.5, width=3, units='in', plot = F1a)
...
LEG = as_ggplot(LEG)
LEG
ggsave("Fig2f_legend.pdf", height=5, width=6.5, units='in', plot = LEG)

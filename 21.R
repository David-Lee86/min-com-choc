...
#-------------------------------------------------------------------------------------------------
# Import data
heatmap.dataset2 = read.csv("Colombia_RF_Initial_density.csv")
...
Plot2
ggsave("Fig3d_i.pdf", height=1.8, width=4.2, units='in', plot = Plot2)
...
ggsave("Fig3d_i_legend.pdf", height=4, width=8, units='in', plot = legend)

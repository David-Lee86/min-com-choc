...
# -------------------------------------------------------------------------------------------------
##import data
LC = read.csv("venn_diagram_community_taxaonmy.csv")
...
names(LC) <- c("Defined community","SYNCOM")
A1 = ggvenn(LC, text_size=4, text_color = "black",
  fill_color = c("#f19d06", "#7a972b"),
  fill_alpha = 0.7,
  stroke_size = 0.5, set_name_size = 3.7
)
A1
ggsave("Fig4d.pdf", height=2, width=3, units='in', plot = A1)
